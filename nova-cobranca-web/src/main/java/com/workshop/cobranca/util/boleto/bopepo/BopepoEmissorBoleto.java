...
public class BopepoEmissorBoleto implements EmissorBoleto {
	...
	@Override
	public byte[] gerarBoleto(com.workshop.cobranca.model.Cedente cedenteSistema, Cobranca cobrancaSistema) {
	...
	@Override
	public File gerarBoletoEmArquivo(String arquivo, com.workshop.cobranca.model.Cedente cedenteSistema, Cobranca cobrancaSistema) {
		Boleto boleto = criarBoleto(cedenteSistema, cobrancaSistema);
		BoletoViewer boletoViewer = new BoletoViewer(boleto);
		return boletoViewer.getPdfAsFile(arquivo);
	}

	private Boleto criarBoleto(com.workshop.cobranca.model.Cedente cedenteSistema, Cobranca cobrancaSistema) {
	...
	private ContaBancaria criarContaBancaria(com.workshop.cobranca.model.Cedente cedenteSistema) {
		...
		String digitoConta = cedenteSistema.getContaBancaria().getDigitoAgencia();
	...
	private Titulo criarTitulo(ContaBancaria contaBancaria, Sacado sacado, Cedente cedente, Cobranca cobrancaSistema) {
